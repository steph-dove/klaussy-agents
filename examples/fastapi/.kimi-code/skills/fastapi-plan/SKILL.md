...
> - Where it references "plan mode" or `ExitPlanMode`, use Kimi's plan mode — `EnterPlanMode` to analyze and draft without touching files, then `ExitPlanMode` to submit the plan before implementing.
