...
If `klaussy` isn't on PATH (the command isn't found), follow `.gemini/antigravity-cli/plugins/klaussy/skills/fastapi-restack/manual.md` instead; it's the same procedure by hand.
