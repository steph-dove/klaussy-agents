"""Per-agent backends. Each turns canonical klausify output into native files.
...
from klausify.agents.base import (
    CapabilityProfile,
    ConventionsDoc,
...
class CodexBackend(GenericBackend):
    ...
    def emit_settings(self, repo, *, force):
        ...
        content = (
            "# Generated by klausify. Codex project config (loaded when trusted).\n"
